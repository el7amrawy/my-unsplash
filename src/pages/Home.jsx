    ...
    <main className="w-5/6 mx-auto mt-12  flex flex-wrap flex-col items-center lg:flex-row lg:items-start">
      ...
      <div className=" w-full my-5 lg:w-1/3 flex flex-col items-center">
        <div className=" w-10/12">
          ...
          <Photo
            className=" mt-10"
            imgURL="https://img.freepik.com/free-vector/mandala-illustration_53876-81806.jpg?w=996&t=st=1664303290~exp=1664303890~hmac=566899483ef62cd004cb041811139892f4e023db1b8f4f83e0ae8adf5260a8af"
          />
        </div>
      </div>
      <div className=" w-full my-5 lg:w-1/3 flex flex-col items-center">
